...
edges = sub2ind(size(A),...
    [1,2,2,2,3,5,6,6,6,7,7,7,8,9,10,11,11,12,14,15,15,15,16,17,17,17,18,18,...
    18,20,21,22,23,24,24,24,25,25,25,26,27,28,28,29,31,32,34],...
    [4,3,6,7,5,1,3,4,9,8,15,16,10,11,6,13,14,13,12,8,9,20,17,20,21,22,19,23,...
    26,19,15,18,27,17,18,23,26,32,33,28,25,30,31,30,29,34,33]);
A(edges) = 1;
